...
rrdtool graph - -a SVG --title "cpu usage" --vertical-label "%core" DEF:lighthousecpu=resource.rrd:lighthousecpu:AVERAGE DEF:rethcpu=resource.rrd:rethcpu:AVERAGE AREA:rethcpu#0000ff:"reth" STACK:lighthousecpu#00ff00:"lighthouse" | sed 's/glyph/glyph-img0/g'

rrdtool graph - -a SVG --title "mem usage" --vertical-label "GB" DEF:lighthousemem=resource.rrd:lighthousemem:AVERAGE DEF:rethmem=resource.rrd:rethmem:AVERAGE AREA:rethmem#0000ff:"reth" STACK:lighthousemem#00ff00:"lighthouse" | sed 's/glyph/glyph-img1/g'
